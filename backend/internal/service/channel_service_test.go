...
type mockChannelRepository struct {
	...
	listFn                     func(ctx context.Context, params pagination.PaginationParams, status, search, providerScope string) ([]Channel, *pagination.PaginationResult, error)
...
func (m *mockChannelRepository) List(ctx context.Context, params pagination.PaginationParams, status, search, providerScope string) ([]Channel, *pagination.PaginationResult, error) {
	if m.listFn != nil {
		return m.listFn(ctx, params, status, search, providerScope)
	}
	return nil, nil, nil
}
