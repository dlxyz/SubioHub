...
// Group routing profile constants
const (
	GroupRoutingProfileOverseas = domain.GroupRoutingProfileOverseas
	GroupRoutingProfileDomestic = domain.GroupRoutingProfileDomestic
	GroupRoutingProfileMixed    = domain.GroupRoutingProfileMixed
)
...
const (
	...
	SettingKeyFrontendURL                      = "frontend_url"                        // 站点基础 URL，用于生成邮件中的重置密码链接
