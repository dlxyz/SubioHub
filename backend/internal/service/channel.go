...
const (
	...
	ProviderTypeOpenAICompatDomestic = "openai_compat_domestic"
	ProviderTypeCustomDomestic       = "custom_domestic"
)
...
type Channel struct {
	...
	ProviderType       string         // 渠道执行适配器类型（standard/deepseek/...）
	ProviderConfig     map[string]any // 上游 provider 配置（base_url/api_key/model options 等）
...
func (c *Channel) Clone() *Channel {
	...
	if c.ProviderConfig != nil {
		cp.ProviderConfig = deepCopyFeaturesConfig(c.ProviderConfig)
	}
