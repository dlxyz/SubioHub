...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"openai embeddings stays embeddings", EndpointEmbeddings, "/v1/embeddings", service.PlatformOpenAI, EndpointEmbeddings},
		{"openai rerank stays rerank", EndpointRerank, "/v1/rerank", service.PlatformOpenAI, EndpointRerank},
