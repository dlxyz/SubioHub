...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	response.Success(c, dto.SystemSettings{
		...
		AffiliateAutoSettlementEnabled:           settings.AffiliateAutoSettlementEnabled,
		AffiliateManualPayoutSettlementEnabled:   settings.AffiliateManualPayoutSettlementEnabled,
		KeyAccountVIPRechargeThreshold:           settings.KeyAccountVIPRechargeThreshold,
		KeyAccountEnterpriseRechargeThreshold:    settings.KeyAccountEnterpriseRechargeThreshold,
		KeyAccountVIPMonthlyCostThreshold:        settings.KeyAccountVIPMonthlyCostThreshold,
		KeyAccountEnterpriseMonthlyCostThreshold: settings.KeyAccountEnterpriseMonthlyCostThreshold,
		KeyAccountVIPDefaultDiscountRate:         settings.KeyAccountVIPDefaultDiscountRate,
		KeyAccountEnterpriseDefaultDiscountRate:  settings.KeyAccountEnterpriseDefaultDiscountRate,
		KeyAccountVIPDefaultRebateRate:           settings.KeyAccountVIPDefaultRebateRate,
		KeyAccountEnterpriseDefaultRebateRate:    settings.KeyAccountEnterpriseDefaultRebateRate,
		KeyAccountAutoUpgradeEnabled:             settings.KeyAccountAutoUpgradeEnabled,
		KeyAccountAutoDowngradeEnabled:           settings.KeyAccountAutoDowngradeEnabled,
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		AffiliateAutoSettlementEnabled: func() bool {
			if req.AffiliateAutoSettlementEnabled != nil {
				return *req.AffiliateAutoSettlementEnabled
			}
			return previousSettings.AffiliateAutoSettlementEnabled
		}(),
		AffiliateManualPayoutSettlementEnabled: func() bool {
			if req.AffiliateManualPayoutSettlementEnabled != nil {
				return *req.AffiliateManualPayoutSettlementEnabled
			}
			return previousSettings.AffiliateManualPayoutSettlementEnabled
		}(),
		KeyAccountVIPRechargeThreshold: func() float64 {
			if req.KeyAccountVIPRechargeThreshold != nil {
				return *req.KeyAccountVIPRechargeThreshold
			}
			return previousSettings.KeyAccountVIPRechargeThreshold
		}(),
		KeyAccountEnterpriseRechargeThreshold: func() float64 {
			if req.KeyAccountEnterpriseRechargeThreshold != nil {
				return *req.KeyAccountEnterpriseRechargeThreshold
			}
			return previousSettings.KeyAccountEnterpriseRechargeThreshold
		}(),
		KeyAccountVIPMonthlyCostThreshold: func() float64 {
			if req.KeyAccountVIPMonthlyCostThreshold != nil {
				return *req.KeyAccountVIPMonthlyCostThreshold
			}
			return previousSettings.KeyAccountVIPMonthlyCostThreshold
		}(),
		KeyAccountEnterpriseMonthlyCostThreshold: func() float64 {
			if req.KeyAccountEnterpriseMonthlyCostThreshold != nil {
				return *req.KeyAccountEnterpriseMonthlyCostThreshold
			}
			return previousSettings.KeyAccountEnterpriseMonthlyCostThreshold
		}(),
		KeyAccountVIPDefaultDiscountRate: func() float64 {
			if req.KeyAccountVIPDefaultDiscountRate != nil {
				return *req.KeyAccountVIPDefaultDiscountRate
			}
			return previousSettings.KeyAccountVIPDefaultDiscountRate
		}(),
		KeyAccountEnterpriseDefaultDiscountRate: func() float64 {
			if req.KeyAccountEnterpriseDefaultDiscountRate != nil {
				return *req.KeyAccountEnterpriseDefaultDiscountRate
			}
			return previousSettings.KeyAccountEnterpriseDefaultDiscountRate
		}(),
		KeyAccountVIPDefaultRebateRate: func() float64 {
			if req.KeyAccountVIPDefaultRebateRate != nil {
				return *req.KeyAccountVIPDefaultRebateRate
			}
			return previousSettings.KeyAccountVIPDefaultRebateRate
		}(),
		KeyAccountEnterpriseDefaultRebateRate: func() float64 {
			if req.KeyAccountEnterpriseDefaultRebateRate != nil {
				return *req.KeyAccountEnterpriseDefaultRebateRate
			}
			return previousSettings.KeyAccountEnterpriseDefaultRebateRate
		}(),
		KeyAccountAutoUpgradeEnabled: func() bool {
			if req.KeyAccountAutoUpgradeEnabled != nil {
				return *req.KeyAccountAutoUpgradeEnabled
			}
			return previousSettings.KeyAccountAutoUpgradeEnabled
		}(),
		KeyAccountAutoDowngradeEnabled: func() bool {
			if req.KeyAccountAutoDowngradeEnabled != nil {
				return *req.KeyAccountAutoDowngradeEnabled
			}
			return previousSettings.KeyAccountAutoDowngradeEnabled
		}(),
	}
	...
	response.Success(c, dto.SystemSettings{
		...
		AffiliateAutoSettlementEnabled:           updatedSettings.AffiliateAutoSettlementEnabled,
		AffiliateManualPayoutSettlementEnabled:   updatedSettings.AffiliateManualPayoutSettlementEnabled,
		KeyAccountVIPRechargeThreshold:           updatedSettings.KeyAccountVIPRechargeThreshold,
		KeyAccountEnterpriseRechargeThreshold:    updatedSettings.KeyAccountEnterpriseRechargeThreshold,
		KeyAccountVIPMonthlyCostThreshold:        updatedSettings.KeyAccountVIPMonthlyCostThreshold,
		KeyAccountEnterpriseMonthlyCostThreshold: updatedSettings.KeyAccountEnterpriseMonthlyCostThreshold,
		KeyAccountVIPDefaultDiscountRate:         updatedSettings.KeyAccountVIPDefaultDiscountRate,
		KeyAccountEnterpriseDefaultDiscountRate:  updatedSettings.KeyAccountEnterpriseDefaultDiscountRate,
		KeyAccountVIPDefaultRebateRate:           updatedSettings.KeyAccountVIPDefaultRebateRate,
		KeyAccountEnterpriseDefaultRebateRate:    updatedSettings.KeyAccountEnterpriseDefaultRebateRate,
		KeyAccountAutoUpgradeEnabled:             updatedSettings.KeyAccountAutoUpgradeEnabled,
		KeyAccountAutoDowngradeEnabled:           updatedSettings.KeyAccountAutoDowngradeEnabled,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, req UpdateSettingsRequest) []string {
	...
	if before.AffiliateAutoSettlementEnabled != after.AffiliateAutoSettlementEnabled {
		changed = append(changed, "affiliate_auto_settlement_enabled")
	}
	if before.AffiliateManualPayoutSettlementEnabled != after.AffiliateManualPayoutSettlementEnabled {
		changed = append(changed, "affiliate_manual_payout_settlement_enabled")
	}
	return changed
}
