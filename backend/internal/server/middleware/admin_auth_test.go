...
func TestAdminAuthJWTValidatesTokenVersion(t *testing.T) {
	...
	t.Run("websocket_token_version_mismatch_rejected", func(t *testing.T) {
		...
		req.Header.Set("Sec-WebSocket-Protocol", "subiohub-admin, jwt."+token)
		router.ServeHTTP(w, req)
...
func (s *stubUserRepo) UpdateCommissionBalance(ctx context.Context, id int64, amount float64) error {
