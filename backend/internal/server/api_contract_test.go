...
import (
	...
	adminhandler "github.com/dlxyz/SubioHub/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "SubioHub",
					...
					service.SettingKeySiteName:     "SubioHub",
			...
			wantJSON: `{
				...
				"data": {
					...
					"affiliate_auto_settlement_enabled": false,
					"affiliate_manual_payout_settlement_enabled": true,
					...
					"news_translation_api_key_configured": false,
					"news_translation_base_url": "https://api.openai.com/v1",
					"news_translation_model": "",
					"news_translation_temperature": 0,
					"news_translation_timeout_seconds": 60,
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(userRepo, groupRepo, &accountRepo, proxyRepo, apiKeyRepo, redeemRepo, nil, usageRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func (r *stubUserRepo) UpdateCommissionBalance(ctx context.Context, id int64, amount float64) error {
	return errors.New("not implemented")
}
