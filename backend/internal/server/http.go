...
import (
	...
	"github.com/dlxyz/SubioHub/internal/pkg/websearch"
...
func ProvideHTTPServer(cfg *config.Config, router *gin.Engine) *http.Server {
	...
	if cfg.Server.H2C.Enabled {
		...
		log.Printf("HTTP/2 Cleartext (h2c) enabled: max_concurrent_streams=%d, max_read_frame_size=%d, max_upload_buffer_per_connection=%d, max_upload_buffer_per_stream=%d",
