...
func registerNewsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	news := admin.Group("/news")
	{
		news.GET("", h.Admin.News.List)
		news.POST("", h.Admin.News.Create)
		news.GET("/:id", h.Admin.News.GetByID)
		news.PUT("/:id", h.Admin.News.Update)
		news.DELETE("/:id", h.Admin.News.Delete)
		news.POST("/:id/translations/:locale/ai-translate", h.Admin.News.AITranslate)
	}
}
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.POST("/test-connection", h.Admin.Channel.TestDomesticConnection)
		channels.POST("/test-embeddings", h.Admin.Channel.TestDomesticEmbeddings)
		channels.POST("/test-messages", h.Admin.Channel.TestDomesticMessages)
		channels.POST("/test-responses", h.Admin.Channel.TestDomesticResponses)
		channels.POST("/test-rerank", h.Admin.Channel.TestDomesticRerank)
		channels.POST("/fetch-models", h.Admin.Channel.FetchDomesticModels)
