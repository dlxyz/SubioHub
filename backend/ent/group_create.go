...
func (_c *GroupCreate) SetRoutingProfile(v string) *GroupCreate {
	_c.mutation.SetRoutingProfile(v)
	return _c
}

// SetNillableRoutingProfile sets the "routing_profile" field if the given value is not nil.
func (_c *GroupCreate) SetNillableRoutingProfile(v *string) *GroupCreate {
	if v != nil {
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.RoutingProfile(); !ok {
		return &ValidationError{Name: "routing_profile", err: errors.New(`ent: missing required field "Group.routing_profile"`)}
	}
	if v, ok := _c.mutation.RoutingProfile(); ok {
		if err := group.RoutingProfileValidator(v); err != nil {
			return &ValidationError{Name: "routing_profile", err: fmt.Errorf(`ent: validator failed for field "Group.routing_profile": %w`, err)}
		}
	}
	if _, ok := _c.mutation.SubscriptionType(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.RoutingProfile(); ok {
		_spec.SetField(group.FieldRoutingProfile, field.TypeString, value)
...
// SetRoutingProfile sets the "routing_profile" field.
func (u *GroupUpsert) SetRoutingProfile(v string) *GroupUpsert {
	u.Set(group.FieldRoutingProfile, v)
	return u
}

// UpdateRoutingProfile sets the "routing_profile" field to the value that was provided on create.
func (u *GroupUpsert) UpdateRoutingProfile() *GroupUpsert {
	u.SetExcluded(group.FieldRoutingProfile)
	return u
}
...
// SetRoutingProfile sets the "routing_profile" field.
func (u *GroupUpsertOne) SetRoutingProfile(v string) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
...
// UpdateRoutingProfile sets the "routing_profile" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateRoutingProfile() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
...
// SetRoutingProfile sets the "routing_profile" field.
func (u *GroupUpsertBulk) SetRoutingProfile(v string) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetRoutingProfile(v)
	})
}
...
// UpdateRoutingProfile sets the "routing_profile" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateRoutingProfile() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateRoutingProfile()
	})
}
