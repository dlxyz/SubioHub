...
func RoutingProfile(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldRoutingProfile, v))
}
...
func RoutingProfileEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldRoutingProfile, v))
}

// RoutingProfileNEQ applies the NEQ predicate on the "routing_profile" field.
func RoutingProfileNEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldRoutingProfile, v))
}

// RoutingProfileIn applies the In predicate on the "routing_profile" field.
func RoutingProfileIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldRoutingProfile, vs...))
}

// RoutingProfileNotIn applies the NotIn predicate on the "routing_profile" field.
func RoutingProfileNotIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldRoutingProfile, vs...))
}

// RoutingProfileGT applies the GT predicate on the "routing_profile" field.
func RoutingProfileGT(v string) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldRoutingProfile, v))
}

// RoutingProfileGTE applies the GTE predicate on the "routing_profile" field.
func RoutingProfileGTE(v string) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldRoutingProfile, v))
}

// RoutingProfileLT applies the LT predicate on the "routing_profile" field.
func RoutingProfileLT(v string) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldRoutingProfile, v))
}

// RoutingProfileLTE applies the LTE predicate on the "routing_profile" field.
func RoutingProfileLTE(v string) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldRoutingProfile, v))
}

// RoutingProfileContains applies the Contains predicate on the "routing_profile" field.
func RoutingProfileContains(v string) predicate.Group {
	return predicate.Group(sql.FieldContains(FieldRoutingProfile, v))
}

// RoutingProfileHasPrefix applies the HasPrefix predicate on the "routing_profile" field.
func RoutingProfileHasPrefix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasPrefix(FieldRoutingProfile, v))
}

// RoutingProfileHasSuffix applies the HasSuffix predicate on the "routing_profile" field.
func RoutingProfileHasSuffix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasSuffix(FieldRoutingProfile, v))
}

// RoutingProfileEqualFold applies the EqualFold predicate on the "routing_profile" field.
func RoutingProfileEqualFold(v string) predicate.Group {
	return predicate.Group(sql.FieldEqualFold(FieldRoutingProfile, v))
}

// RoutingProfileContainsFold applies the ContainsFold predicate on the "routing_profile" field.
func RoutingProfileContainsFold(v string) predicate.Group {
	return predicate.Group(sql.FieldContainsFold(FieldRoutingProfile, v))
}
