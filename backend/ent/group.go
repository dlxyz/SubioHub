...
type Group struct {
	...
	// 分组用途/路由类型：overseas, domestic, mixed
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldStatus, group.FieldPlatform, group.FieldRoutingProfile, group.FieldSubscriptionType, group.FieldDefaultMappedModel:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldRoutingProfile:
			if value, ok := values[i].(*sql.NullString); !ok {
