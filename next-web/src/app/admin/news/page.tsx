...
const NEWS_LOCALE_OPTIONS = ['zh', 'en', 'es', 'vi', 'ar', 'id', 'pt', 'ja', 'ko', 'th', 'ru'];
...
export default function AdminNewsPage() {
  ...
  const [selectedEditLocale, setSelectedEditLocale] = useState('zh');
  const [newEditLocale, setNewEditLocale] = useState('en');
  const [aiSourceLocale, setAISourceLocale] = useState('zh');
